...
export const AI_MODELS: Record<AiProvider, AiModelOption[]> = {
  gemini: [
    {
      ...
      description: "Next-gen ultra-lightweight and fast multimodal extraction model",
      badge: "Latest",
      supportsVision: true,
    },
    {
      ...
      provider: "gemini",
      category: "Gemini 3.x Series",
      description: "Advanced next-gen multimodal reasoning model",
      supportsVision: true,
    },
    {
      id: "gemini-2.5-flash",
  ...
  groq: [
    ...
    },
    {
      ...
      description: "Latest Qwen 3.8 multimodal model with precision extraction and vision capabilities",
      badge: "Vision & Text",
      supportsVision: true,
    },
    {
      ...
      provider: "groq",
      category: "Alibaba Cloud",
      description: "High-accuracy multilingual reasoning and vision model",
      badge: "Vision",
      supportsVision: true,
    },
    {
