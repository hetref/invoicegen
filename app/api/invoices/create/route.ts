  ...
  try {
    ...
    const dbInvoiceData = {
      ...
      paymentDetails: {
        ...
        isPaid: Boolean(invoiceData.isPaid ?? invoiceData.paymentDetails?.isPaid),
        paidAt: invoiceData.paidAt || invoiceData.paymentDetails?.paidAt || (invoiceData.isPaid ? new Date().toISOString() : null),
      },
      contactInfo: {
        phone: invoiceData.contact?.phone || "",
        email: invoiceData.contact?.email || "",
        website: invoiceData.contact?.website || "",
        includeLogo: Boolean(invoiceData.includeLogo),
